...
export function buildSeedPosts(now: number): SocialPost[] {
  return [
    ...
    /** Celsius (finished) — preserved final metrics. */
    {
      id: "post-demo-celsius",
      orgId: DEMO_ORG_ID,
      platform: "instagram",
      url: "https://instagram.com/p/sk-celsius-finals",
      caption: "Finals fuel station was a hit 💪",
      postedAt: now - 11 * MS_PER_DAY,
      metrics: { likes: 720, comments: 48, fetchedAt: now - 8 * MS_PER_DAY },
    },
    {
      id: "post-cornell-celsius",
      orgId: "org-cornell-alpha-phi",
      platform: "tiktok",
      url: "https://tiktok.com/@cornell-ap/celsius",
      caption: "All-nighter survival kit 📚",
      postedAt: now - 11 * MS_PER_DAY,
    ...
    },
    {
      ...
      platform: "instagram",
      url: "https://instagram.com/p/nyu-celsius",
      caption: "Library run on Celsius ⚡",
